...
#
# Repository path   : $HeadURL: svn://heros.hephy.oeaw.ac.at/GlobalTriggerUpgrade/software/tdf/trunk/lib/tdf/mp7/images.py $
# Last committed    : $Revision: 3138 $
# Last changed by   : $Author: arnold $
# Last changed date : $Date: 2014-09-04 12:05:01 +0200 (Thu, 04 Sep 2014) $
#
    ...
    def fromTestVector(self, filename, quads = 4, frames = 1024):
        ...
        with open(filename) as fs:
            ...
            for i in range(len(tv.extconds())):
                ...
                #
                mapped_values = [
                    [0,                   0,                   0,                   0,                   tv.eg(0)[i], tv.eg(6)[i],  tv.jet(0)[i], tv.jet(6)[i],  tv.tau(0)[i], tv.tau(6)[i], tv.ett()[i], 0, extconds[0], extconds[1], extconds[2], extconds[3], ],
                    [0,                   0,                   0,                   0,                   tv.eg(1)[i], tv.eg(7)[i],  tv.jet(1)[i], tv.jet(7)[i],  tv.tau(1)[i], tv.tau(7)[i], tv.ht()[i],  0, extconds[4], extconds[5], extconds[6], extconds[7], ],
